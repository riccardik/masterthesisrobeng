...
while True:
  ...
  print file_number
  fname = "./log_status/data"+file_number+".txt"
  minmax_fname = "./log_status/data"+file_number+"minmaxdenorm.txt"
  ...
  norma_fname = "./log_status/data"+str(file_number)+"_denorma.txt"
  normv_fname = "./log_status/data"+str(file_number)+"_denormv.txt"
  norml_fname = "./log_status/data"+str(file_number)+"_denorml.txt"
  print fname
  try:
